...
[![Version](https://img.shields.io/badge/Version-v0.18.2-green.svg)](https://github.com/Sandjab/clio/releases/tag/v0.18.2)
...
**v0.18.2 (current)**: **5 compilation targets** (`claude-cli`, `python`, `mcp-server`, `langgraph`, `claude-skill`). **996 unit tests + 1 xfail + gated e2e.**

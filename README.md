...
[![Version](https://img.shields.io/badge/Version-v0.15.1-green.svg)](https://github.com/Sandjab/clio/releases/tag/v0.15.1)
...
**v0.15.1 (current)**: **5 compilation targets** (`claude-cli`, `python`, `mcp-server`, `langgraph`, `claude-skill`). **834 unit tests + 1 xfail + gated e2e.**

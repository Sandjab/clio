...
[![Version](https://img.shields.io/badge/Version-v0.18.1-green.svg)](https://github.com/Sandjab/clio/releases/tag/v0.18.1)
...
**v0.18.1 (current)**: **5 compilation targets** (`claude-cli`, `python`, `mcp-server`, `langgraph`, `claude-skill`). **993 unit tests + 1 xfail + gated e2e.**

...
TAKES are substituted into the URL via ${{var}} placeholders;
templating of headers/body and parsing of query/headers/body fields is
not yet supported. retries is parsed but not honored at runtime.
"""
...
{argparse_block}
    args = parser.parse_args()
{unused_takes}{url_block}    response = requests.request(
        method={method!r},
        url={url_arg},
